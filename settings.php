...
foreach ( $options as $item) {
        ...
        foreach ($arr as $item) {
            ...
            $qcf_email[$item] = filter_var($qcf_email[$item],FILTER_VALIDATE_EMAIL);
        }
...
<input style="margin:0; padding:0; border:none" type="radio" name="selectorb" value="radiob" ' .$radiob . ' /> Radio<br><span class="description">Options (separate with a comma):</span><br><textarea  name="checklist_string" label="Checklist" rows="2">' . $qcf['checklist'] . '</textarea>'; 
            break;
            case 'field7':
            $type = 'Selector'; 
...
<input style="margin:0; padding:0; border:none" type="radio" name="selectorc" value="radioc" ' .$radioc . ' /> Radio<br><span class="description">Options (separate with a comma):</span><br><textarea  name="radio_string" label="Radio" rows="2">' . $qcf['radiolist'] . '</textarea>'; 
            break;
...
function qcf_attach ($id) {
    ...
    <tr><td></td><td><input type="checkbox" style="margin: 0; padding: 0; border: none;" name="qcf_attach"' . $attach['qcf_attach'] . ' value="checked" /> User can attach files</td></tr>		
    <tr><td>Field Label</td><td><input type="text" name="qcf_attach_label" value="' . $attach['qcf_attach_label'] . '" /></td></tr>
    ...
    <tr>
    <td>If the filetype is incorrect:</td><td><input type="text" name="qcf_attach_error_type" value="' . $attach['qcf_attach_error_type'] . '" /></td>
    </tr>
    </table>
...
function qcf_styles($id) {
    ...
    <tr><td>Header Size: </td><td><input type="text" style="width:6em" label="header-size" name="header-size" value="' . $style['header-size'] . '" /></td>
    </tr>
    <tr>
    <td>Header Colour: </td><td><input type="text" class="qcf-color" label="header-colour" name="header-colour" value="' . $style['header-colour'] . '" /></td>
    </tr>
    <tr>
    ...
    <tr>
    <td>Focus: </td><td><input type="text" class="qcf-color" label="inputfocus" name="inputfocus" value="' . $style['inputfocus'] . '" /></td>
    </tr>
    ...
    <tr>
    <td>Font Family: </td><td><input type="text" label="text-font-family" name="text-font-family" value="' . $style['text-font-family'] . '" /></td>
    </tr>
    <tr>
    <td>Font Size: </td><td><input type="text" style="width:6em" label="text-font-size" name="text-font-size" value="' . $style['text-font-size'] . '" /></td>
    </tr>
    <tr>
    <td>Font Colour: </td><td><input type="text" class="qcf-color" label="text-font-colour" name="text-font-colour" value="' . $style['text-font-colour'] . '" /></td>
    </tr>
    <tr>
...
function qcf_reply_page($id) {
    ...
    <tr>
    <td colspan="2"><h2>Email Message</h2></td>
    </tr>
    <tr><td>
    </td><td><input style="margin:0; padding:0; border:none" type="checkbox" name="sendcopy" ' . $reply['sendcopy'] . ' value="checked"> Send an email message to the sender.</td>
    </tr>
    <tr><td>Email Subject:</td>
    <td><input type="text" name="replysubject" value="' . $reply['replysubject'] . '"/></td>
    </tr>
    <tr>
    <td>Email Message</td>
    <td><textarea height: 100px" name="replymessage">' . $reply['replymessage'] . '</textarea>
    <input style="margin:0; padding:0; border:none" type="checkbox" name="replycopy" ' . $reply['replycopy'] . ' value="checked"> Add the content of the email they sent to you.</td>
    </tr>
    <tr>
...
function qcf_reset_page($id) {
    qcf_change_form_update();
    if (isset($_POST['qcf_reset']) && check_admin_referer("save_qcf")) {
        ...
        if (isset($_POST['qcf_reset_form']) && check_admin_referer("save_qcf")) {
            qcf_delete_things($id);
        ...
        if (isset($_POST['qcf_reset_everything'])) {
            ...
            foreach ($id as $item) qcf_delete_things($id);
