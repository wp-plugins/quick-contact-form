...
function qcf_form_options () {
	...
	$content = '
		...
		<li>Select the fields you want on your form and edit the field labels if required.</li>
...
function qcf_styles()
	...
	$content ='
		...
		<p>The styling features are a bit naff at the moment. It&#146;s actually easier for you to update the CSS than mess about here. However, if there is something you really want to see then email me at <a href="mailto:graham@aerin.co.uk">graham@aerin.co.uk</a>.
		</div>
		</div>
		<div id="qcf-options"> 
		<h2>Test Form</h2>
...
function qcf_reply_page()
	...
	$content ='
		...
		<p><input type="radio" style="margin:0; padding: 0; border: none" name="subjectoption" value="senderpage" ' . $spage . '> page title (only works if send form a post or a page)</p>
