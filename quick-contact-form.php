...
wp_enqueue_script( 'nofuss_script');
...
function qcf_options_page()
	...
	<h2>Description</h2>
	<p>This contact form plugin very simple and can be used almost straight out the box. All you need to do is add your email address, save and insert the shortcode into your posts and pages.
